        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="font-semibold text-xl text-gray-700 leading-tight">Получен в пункт А</h3>
                    <div class="info-container">
                        ...
                        <form action="{{ route('product.create') }}" method="POST" class="form-horizontal">
                            ...
                            <div class="info-row">
                                ...
                                <input type="hidden" name="status" id="product-status" class="form-control"  value="receipt_A">
