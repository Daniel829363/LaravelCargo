        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="font-semibold text-xl text-gray-700 leading-tight">Выдан клиенту</h3>
                    <div class="info-container">
                        <form action="{{ route('product.create4') }}" method="POST" class="form-horizontal">
                            @csrf
                            @method('PATCH')
                            <div class="info-row">
                            ...
                            <input type="hidden" name="status" id="product-status" class="form-control"  value="issue">
